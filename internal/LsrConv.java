...
public abstract class LsrConv extends Conversions
{
    ...
    protected abstract void setTransformMatrix(BaseSRF srcSrf, BaseSRF destSrf) throws SrmException;
 ...
 *----------------------------------------------------------------------------
 */
    protected void toLsr(BaseSRF  srcSrf,
			 BaseSRF  destSrf,
	...
	Const.applyMatrix3x3(source_generic_coord,
