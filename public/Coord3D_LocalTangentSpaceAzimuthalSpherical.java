...
public class Coord3D_LocalTangentSpaceAzimuthalSpherical extends Coord3D
{
    ...
    */
    public Coord3D_LocalTangentSpaceAzimuthalSpherical( SRF_LocalTangentSpaceAzimuthalSpherical srf )
    {
        super( srf, Coord_ClassType.LTSAS_3D );
    ...
    */
    ...
    /** Copy constructor
    */
    public Coord3D_LocalTangentSpaceAzimuthalSpherical( Coord3D_LocalTangentSpaceAzimuthalSpherical original)
    {
        super( original.getSRF(), Coord_ClassType.LTSAS_3D);
