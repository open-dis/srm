...
public class SRF_LocalTangentSpaceAzimuthalSpherical extends BaseSRF_WithTangentPlaneSurface
{
    ...
    {
       SrfCheck.forLocalTangentSpaceAzimuthalSpherical(orm, rt, params);

       _mySrftCode = SRM_SRFT_Code.SRFTCOD_LOCAL_TANGENT_SPC_AZIMUTHAL_SPHERICAL;
       _myCsCode = SRM_CS_Code.CSCOD_LOCOCENT_AZIMUTHAL_SPHERICAL;
       _orm = orm;
       _rt = rt;
    ...
    public SRF_LocalTangentSpaceAzimuthalSpherical
    (
        SRM_ORM_Code orm,
        SRM_RT_Code rt,
    ...
    ) throws SrmException
    {
       ...
       SrfCheck.forLocalTangentSpaceAzimuthalSpherical(_orm, _rt, _params);
    }
    ...
    {
        return new Coord3D_LocalTangentSpaceAzimuthalSpherical
                   ((SRF_LocalTangentSpaceAzimuthalSpherical)this,
                    Double.NaN, Double.NaN, Double.NaN);
    }
    ...
    {
        return new CoordSurf_LocalTangentSpaceAzimuthalSpherical
                   ((SRF_LocalTangentSpaceAzimuthalSpherical)this,
    ...
    /** @return the SRF parameter object */
