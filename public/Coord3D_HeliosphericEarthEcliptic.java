...
public class Coord3D_HeliosphericEarthEcliptic extends Coord3D
{
    ...
    {
        super( srf, Coord_ClassType.HEEC_3D );
    ...
    /** Copy constructor
     */
    public Coord3D_HeliosphericEarthEcliptic( Coord3D_HeliosphericEarthEcliptic original)
    {
        super( original.getSRF(), Coord_ClassType.HEEC_3D);
