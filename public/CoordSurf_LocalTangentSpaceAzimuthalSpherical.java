...
public class CoordSurf_LocalTangentSpaceAzimuthalSpherical extends CoordSurf
{
    ...
    */
    public CoordSurf_LocalTangentSpaceAzimuthalSpherical( SRF_LocalTangentSpaceAzimuthalSpherical srf )
    {
        super( srf, Coord_ClassType.LTSAS_SURFACE) ;
    ...
    */
    ...
    {
        super( original.getSRF(), Coord_ClassType.LTSAS_SURFACE);
