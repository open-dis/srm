...
public class SRF_HeliosphericEarthEquatorial extends BaseSRF_3D
{
     ...
     */
    public SRF_HeliosphericEarthEquatorial(SRM_ORM_Code orm,
                                           SRM_RT_Code  rt) throws SrmException
    {
        SrfCheck.forHeliosphericEarthEquatorial(orm, rt);

        _mySrftCode = SRM_SRFT_Code.SRFTCOD_HELIOSPHER_EARTH_EQUATORIAL;
    ...
    {
        return new Coord3D_HeliosphericEarthEquatorial
                   ((SRF_HeliosphericEarthEquatorial)this,
                    Double.NaN, Double.NaN, Double.NaN );
    }
