...
public class Coord3D_SolarEcliptic extends Coord3D
{
    ...
    {
        super( srf, Coord_ClassType.SEC_3D );
        setValues( Double.NaN, Double.NaN, Double.NaN );
    }

    /** Constructor with input values
     */
    public Coord3D_SolarEcliptic
    (
        SRF_SolarEcliptic srf,
        double            longitude,
        double            latitude,
        double            radius
    )
    ...
    /** Copy constructor
     */
    public Coord3D_SolarEcliptic( Coord3D_SolarEcliptic original)
    {
        super( original.getSRF(), Coord_ClassType.SEC_3D);
