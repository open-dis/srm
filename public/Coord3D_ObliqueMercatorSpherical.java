...
public class Coord3D_ObliqueMercatorSpherical extends Coord3D
{
    ...
    {
        super( srf, Coord_ClassType.OMS_AUGMENTED_3D );
        setValues( Double.NaN, Double.NaN, Double.NaN );
    }

    /** Constructor with input values
     */
    public Coord3D_ObliqueMercatorSpherical
    (
        SRF_ObliqueMercatorSpherical srf,
        double                       easting,
        double                       northing,
    ...
    /** Copy constructor
     */
    public Coord3D_ObliqueMercatorSpherical( Coord3D_ObliqueMercatorSpherical original)
    {
        super( original.getSRF(), Coord_ClassType.OMS_AUGMENTED_3D);
