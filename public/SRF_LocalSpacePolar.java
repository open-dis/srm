...
public class SRF_LocalSpacePolar extends BaseSRF_2D
{
     ...
     */
    public SRF_LocalSpacePolar(SRM_ORM_Code orm,
                               SRM_RT_Code  rt) throws SrmException
    {
        SrfCheck.forLocalSpacePolar(orm, rt);

        _mySrftCode = SRM_SRFT_Code.SRFTCOD_LOCAL_SPACE_POLAR_2D;
        _myCsCode   = SRM_CS_Code.CSCOD_POLAR;
        _orm        = orm;
        _rt         = rt;
    }
    ...
    */
    ...
    {
        return ((srf != null) &&
                (srf instanceof SRF_LocalSpacePolar) &&
