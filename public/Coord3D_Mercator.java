...
public class Coord3D_Mercator extends Coord3D
{
    ...
    {
        super( srf, Coord_ClassType.M_AUGMENTED_3D );
        setValues( Double.NaN, Double.NaN, Double.NaN );
    }

    /** Constructor with input values
     */
    public Coord3D_Mercator
    (
        SRF_Mercator srf,
        double       easting,
        double       northing,
    ...
    /** Copy constructor
     */
    public Coord3D_Mercator( Coord3D_Mercator original)
    {
        super( original.getSRF(), Coord_ClassType.M_AUGMENTED_3D);
