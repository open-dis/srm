...
public class CoordSurf_EquidistantCylindrical extends CoordSurf
{
    ...
    */
    ...
    {
        super( srf, Coord_ClassType.EC_SURFACE) ;
    ...
    */
    ...
    /** Copy constructor
    */
    public CoordSurf_EquidistantCylindrical( CoordSurf_EquidistantCylindrical original)
    {
        super( original.getSRF(), Coord_ClassType.EC_SURFACE);
