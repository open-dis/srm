...
This class holds the specific parameters for SRF_TransverseMercator
@author David Shen
*/
public class SRF_TM_Params
{
    ...
    /** Returns TRUE is this object's member data are "equal" to the ones in
        input object.
    */
    public boolean isEqual( SRF_TM_Params params )
    {
        return (
    ...
    */
    public String toString()
    {
        ...
        retString = retString + "origin_longitude: " + origin_longitude+ "\n";
        retString = retString + "origin_latitude: " + origin_latitude+ "\n";
        retString = retString + "central_scale: " + central_scale+ "\n";
        retString = retString + "false_easting: " + false_easting+ "\n";
        retString = retString + "false_northing: " + false_northing;
