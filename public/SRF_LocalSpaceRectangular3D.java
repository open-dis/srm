...
public class SRF_LocalSpaceRectangular3D extends BaseSRF_3D
{
    ...
    {
        SrfCheck.forLocalSpaceRectangular3D(orm, rt, params);

        _mySrftCode = SRM_SRFT_Code.SRFTCOD_LOCAL_SPACE_RECT_3D;
    ...
    {
        return new Coord3D_LocalSpaceRectangular3D
                   ((SRF_LocalSpaceRectangular3D)this,
                    Double.NaN, Double.NaN, Double.NaN );
    }
    ...
    public boolean isEqual( BaseSRF srf )
    {
        return ((srf != null ) &&
                (srf instanceof SRF_LocalSpaceRectangular3D ) &&
                 ...
                 this._rt == srf.getRt() &&
                 this._params.isEqual(((SRF_LocalSpaceRectangular3D)srf).
                                      getSRFParameters()));
    }
