...
public class SRF_EquatorialInertial extends BaseSRF_3D
{
     ...
     */
    public SRF_EquatorialInertial(SRM_ORM_Code orm,
                                  SRM_RT_Code  rt) throws SrmException
    {
        SrfCheck.forEquatorialInertial(orm, rt);

        _mySrftCode = SRM_SRFT_Code.SRFTCOD_EQUATORIAL_INERTIAL;
    ...
    */
    ...
    {
        return ((srf != null) &&
                (srf instanceof SRF_EquatorialInertial) &&
