...
*/
public class Coord3D_LococentricEuclidean3D extends Coord3D
{
    /** Constructor with initial value defaulted to [ Double.NaN, Double.NaN, Double.NaN ]
     */
    public Coord3D_LococentricEuclidean3D( SRF_LococentricEuclidean3D srf )
    {
        super( srf, Coord_ClassType.LCE_3D );
    ...
    /** Copy constructor
     */
    public Coord3D_LococentricEuclidean3D( Coord3D_LococentricEuclidean3D original)
    {
        super( original.getSRF(), Coord_ClassType.LCE_3D);
        setValues(original.get_u(),
                  original.get_v(),
                  original.get_w());
    }
    ...
    */
    public boolean isEqual( Coord coord )
    {
        ...
        return ( (coord instanceof Coord3D_LococentricEuclidean3D) &&
