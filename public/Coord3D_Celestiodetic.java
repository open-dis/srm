...
public class Coord3D_Celestiodetic extends Coord3D
{
    ...
    */
    ...
    {
        super( srf, Coord_ClassType.CD_3D );
   ...
   /** Copy constructor
    */
    public Coord3D_Celestiodetic( Coord3D_Celestiodetic original)
    {
        super( original.getSRF(), Coord_ClassType.CD_3D);
    ...
    */
    public void setValues( double longitude, double latitude, double ellipsoidal_height )
    {
        _values[0] = longitude;
        _values[1] = latitude;
