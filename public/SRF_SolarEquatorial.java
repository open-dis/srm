...
{
    /* SRF_SolarEquatorial only constructor by ORM code and RT code */
    public SRF_SolarEquatorial( SRM_ORM_Code orm,
                                 SRM_RT_Code rt ) throws SrmException
    {
        _mySrftCode = SRM_SRFT_Code.SRFTCOD_SOLAR_EQUATORIAL;
        _myCsCode = SRM_CS_Code.CSCOD_EQUATORIAL_SPHERICAL;
        _orm = orm;
        _rt = rt;

        SrfCheck.forSolarEquatorial( _orm, _rt );
    }
    ...
    {
        return ((srf != null ) &&
                (srf instanceof SRF_SolarEquatorial ) &&
