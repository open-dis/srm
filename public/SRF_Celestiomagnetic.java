...
public class SRF_Celestiomagnetic extends BaseSRF_3D
{
     ...
     */
    public SRF_Celestiomagnetic(SRM_ORM_Code orm,
                                SRM_RT_Code rt) throws SrmException
    {
        SrfCheck.forCelestiomagnetic(orm, rt);

        _mySrftCode = SRM_SRFT_Code.SRFTCOD_CELESTIOMAGNETIC;
    ...
    */
    ...
    {
        return ((srf != null) &&
                (srf instanceof SRF_Celestiomagnetic) &&
