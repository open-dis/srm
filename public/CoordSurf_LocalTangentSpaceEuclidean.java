...
public class CoordSurf_LocalTangentSpaceEuclidean extends CoordSurf
{
    ...
    */
    public CoordSurf_LocalTangentSpaceEuclidean(SRF_LocalTangentSpaceEuclidean srf)
    {
        super(srf, Coord_ClassType.LTSE_SURFACE) ;
    ...
    */
    ...
    /** Copy constructor
    */
    public CoordSurf_LocalTangentSpaceEuclidean(CoordSurf_LocalTangentSpaceEuclidean original)
    {
        super(original.getSRF(), Coord_ClassType.LTSE_SURFACE);
