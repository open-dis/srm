...
public class SRF_LococentricEuclidean3D extends BaseSRF_3D
{
    ...
    {
        SrfCheck.forLococentricEuclidean3D( orm, rt,
                                            params.lococentre,
                                                params.primary_axis,
                                                params.secondary_axis );

        _mySrftCode = SRM_SRFT_Code.SRFTCOD_LOCOCENTRIC_EUCLIDEAN_3D;
        _myCsCode = SRM_CS_Code.CSCOD_LOCOCENT_EUCLIDEAN_3D;
        _orm = orm;
        _rt = rt;
        System.arraycopy( params.lococentre, 0, _params.lococentre, 0, 3 );
        System.arraycopy( params.primary_axis, 0, _params.primary_axis, 0, 3 );
        System.arraycopy( params.secondary_axis, 0, _params.secondary_axis, 0, 3 );
    }
    ...
    ) throws SrmException
    {
        ...
        System.arraycopy( lococentre, 0, _params.lococentre, 0, 3 );
        System.arraycopy( primary_axis, 0, _params.primary_axis, 0, 3 );
        System.arraycopy( secondary_axis, 0, _params.secondary_axis, 0, 3 );
    }
