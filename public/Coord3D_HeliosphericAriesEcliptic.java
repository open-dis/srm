...
public class Coord3D_HeliosphericAriesEcliptic extends Coord3D
{
    ...
    {
        super( srf, Coord_ClassType.HAEC_3D );
    ...
    /** Copy constructor
     */
    public Coord3D_HeliosphericAriesEcliptic( Coord3D_HeliosphericAriesEcliptic original)
    {
        super( original.getSRF(), Coord_ClassType.HAEC_3D);
