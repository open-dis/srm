...
public class SRF_LocalTangentSpaceCylindrical extends BaseSRF_WithTangentPlaneSurface
{
    ...
    {
        SrfCheck.forLocalTangentSpaceCylindrical(orm, rt, params);

        _mySrftCode = SRM_SRFT_Code.SRFTCOD_LOCAL_TANGENT_SPC_CYLINDRICAL;
        _myCsCode = SRM_CS_Code.CSCOD_LOCOCENTRIC_CYLINDRICAL;
        _orm = orm;
        _rt = rt;
    ...
    {
        return new Coord3D_LocalTangentSpaceCylindrical
                   ((SRF_LocalTangentSpaceCylindrical)this,
    ...
    {
        return new CoordSurf_LocalTangentSpaceCylindrical
                   ((SRF_LocalTangentSpaceCylindrical)this,
    ...
    public boolean isEqual( BaseSRF srf )
    {
        return ((srf != null) &&
                (srf instanceof SRF_LocalTangentSpaceCylindrical ) &&
                 ...
                 (((SRF_LocalTangentSpaceCylindrical)srf).getSRFParameters()));
    }
