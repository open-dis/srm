...
public class SRF_Celestiocentric extends BaseSRF_3D
{
     ...
     */
    public SRF_Celestiocentric(SRM_ORM_Code orm,
                               SRM_RT_Code  rt) throws SrmException
    {
        SrfCheck.forCelestiocentric(orm, rt);

        _mySrftCode = SRM_SRFT_Code.SRFTCOD_CELESTIOCENTRIC;
        _myCsCode   = SRM_CS_Code.CSCOD_EUCLIDEAN_3D;
        _orm        = orm;
        _rt         = rt;
    }
    ...
    */
    ...
    {
        return ((srf != null) &&
                (srf instanceof SRF_Celestiocentric) &&
