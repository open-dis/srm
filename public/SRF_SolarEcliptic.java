...
public class SRF_SolarEcliptic extends BaseSRF_3D
{
    ...
    public SRF_SolarEcliptic( SRM_ORM_Code orm,
                              SRM_RT_Code rt ) throws SrmException
    {
        _mySrftCode = SRM_SRFT_Code.SRFTCOD_SOLAR_ECLIPTIC;
        _myCsCode = SRM_CS_Code.CSCOD_EQUATORIAL_SPHERICAL;
        _orm = orm;
        _rt = rt;

        SrfCheck.forSolarEcliptic( _orm, _rt );
    }
    ...
    {
        return new Coord3D_SolarEcliptic( (SRF_SolarEcliptic)this,
    ...
    */
    ...
    {
        return ((srf != null ) &&
                (srf instanceof SRF_SolarEcliptic ) &&
