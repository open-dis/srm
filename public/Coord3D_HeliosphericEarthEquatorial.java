...
public class Coord3D_HeliosphericEarthEquatorial extends Coord3D
{
     ...
     */
    public Coord3D_HeliosphericEarthEquatorial( SRF_HeliosphericEarthEquatorial srf )
    {
        super( srf, Coord_ClassType.HEEQ_3D );
    ...
    /** Copy constructor
     */
    public Coord3D_HeliosphericEarthEquatorial( Coord3D_HeliosphericEarthEquatorial original)
    {
        super( original.getSRF(), Coord_ClassType.HEEQ_3D);
