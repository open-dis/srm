...
This class holds the specific parameters for ORM 2D transformation (h_st)
@author David Shen
*/
public class SRM_ORM_Trans_2D_Params extends SRM_ORM_Trans_Params
{
    ...
    public SRM_ORM_Trans_2D_Params(double delta_x,
                                   double delta_y,
                                   double omega,
                                   double delta_s) throws SrmException
    {
        ...
        if (omega >= Const.TWO_PI || omega <= -Const.TWO_PI)
            throw new SrmException(SrmException._INVALID_INPUT,
                                   new String("SRM_ORM_Trans_2D_Params: Omega parameter out of bounds (-2_PI < omega < 2_PI)"));
    ...
    /** Returns TRUE is this object's member data are "equal" to the ones in
        input object.
    */
    public boolean isEqual(SRM_ORM_Trans_2D_Params params)
    {
        return (
                this._delta_x== params._delta_x &&
                this._delta_y== params._delta_y &&
                this._omega  == params._omega &&
