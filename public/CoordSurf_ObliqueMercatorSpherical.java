...
public class CoordSurf_ObliqueMercatorSpherical extends CoordSurf
{
    ...
    */
    ...
    {
        super(srf, Coord_ClassType.OMS_SURFACE) ;
    ...
    */
    ...
    /** Copy constructor
    */
    public CoordSurf_ObliqueMercatorSpherical(CoordSurf_ObliqueMercatorSpherical original)
    {
        super(original.getSRF(), Coord_ClassType.OMS_SURFACE);
