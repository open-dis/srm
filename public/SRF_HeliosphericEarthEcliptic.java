...
public class SRF_HeliosphericEarthEcliptic extends BaseSRF_3D
{
     ...
     */
    public SRF_HeliosphericEarthEcliptic(SRM_ORM_Code orm,
                                         SRM_RT_Code  rt) throws SrmException
    {
        SrfCheck.forHeliosphericEarthEcliptic(orm, rt);

        _mySrftCode = SRM_SRFT_Code.SRFTCOD_HELIOSPHER_EARTH_ECLIPTIC;
    ...
    {
        return new Coord3D_HeliosphericEarthEcliptic
                   ((SRF_HeliosphericEarthEcliptic)this,
                     Double.NaN, Double.NaN, Double.NaN);
    }
