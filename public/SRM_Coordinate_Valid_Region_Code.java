...
@brief Declaration of SRM_Coordinate_Valid_Region_Code enumeration.
*/
...
public enum SRM_Coordinate_Valid_Region_Code
{
    ...
    */
    ...
    private static Vector<SRM_Coordinate_Valid_Region_Code> _enumVec = new Vector<SRM_Coordinate_Valid_Region_Code>( );

    static
    {
        for (SRM_Coordinate_Valid_Region_Code x : SRM_Coordinate_Valid_Region_Code.values())
        {
            _enumVec.add(x._enumInt, x);
        }
    }

    private SRM_Coordinate_Valid_Region_Code(int enumInt)
    {
        _enumInt = enumInt;
    }


    /** @return the SRM_Coordinate_Valid_Region_Code object from its enumerant value
     */
