...
public class SRF_Planetodetic extends BaseSRF_WithEllipsoidalHeight
{
    ...
    */
    public SRF_Planetodetic( SRM_ORM_Code orm,
                             SRM_RT_Code rt ) throws SrmException
    {
        _mySrftCode = SRM_SRFT_Code.SRFTCOD_PLANETODETIC;
        _myCsCode = SRM_CS_Code.CSCOD_PLANETODETIC;
        _orm = orm;
        _rt = rt;

        SrfCheck.forPlanetodetic( _orm, _rt );
    }
    ...
    */
    ...
    {
        return ((srf != null ) &&
                (srf instanceof SRF_Planetodetic ) &&
