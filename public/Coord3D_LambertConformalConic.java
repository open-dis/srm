...
public class Coord3D_LambertConformalConic extends Coord3D
{
    ...
    {
        super( srf, Coord_ClassType.LCC_AUGMENTED_3D );
    ...
    /** Copy constructor
     */
    public Coord3D_LambertConformalConic( Coord3D_LambertConformalConic original)
    {
        super(original.getSRF(), Coord_ClassType.LCC_AUGMENTED_3D);
